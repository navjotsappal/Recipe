...
<button title="Edit recipe" class="fixedTopRight" onclick="window.location='updateRecipe.php?q=<?php echo $recipeID; ?>'" name="updateRecipe"> <i class="fa fa-edit"></i></button>
      ...
      if(!empty($errorMessage_permissionDenied))
      {
          ...
          <div class="row">
              ...
              <div class="columnTwo">
                  ...
                  <input class="updateRecipeButton"type="button" onclick="window.location='updateRecipe.php?q=<?php echo $recipeID; ?>'" value="UPDATE RECIPE" name="updateRecipe">
