...
try
{
    ...
    if($row===false){                                     //email exists already, source: http://thisinterestsme.com/php-user-registration-form/
        ...
        $errorMessage_permissionDenied="Request rejected! You do not have permission to view this collaborated recipe!";
    }
...
<head>
    <meta charset="UTF-8">
    <title>View collaborated recipe</title>
...
<button title="Edit recipe" class="fixedTopRight" onclick="window.location='updateCollaboratedRecipe.php?q=<?php echo $recipeID; ?>'" name="updateRecipe"> <i class="fa fa-edit"></i></button>
...
if(!empty($errorMessage_permissionDenied))
{
    ...
    <div class="container containerWidth">
        ...
        <div class="row">
            ...
            <div class="columnTwo">
                <h4 class="directionHeading collaborateTimeShare"> <b class="categoryHeadingColor">Email of user collaborated with :</b> <?php echo $collaborateEmail;?></h4>
                <h4 class="directionHeading collaborateTimeShare"> <b class="categoryHeadingColor">Email of user time shared recipe with :</b> <?php echo $shareEmail;?></h4>
                <h4 class="directionHeading collaborateTimeShare"> <b class="categoryHeadingColor">Number of days time shared recipe for :</b> <?php echo $shareTime;?></h4>
                <h4 class="directionHeading collaborateTimeShare"> <b class="categoryHeadingColor">Want to make some changes to this recipe ? </b></h4>

                <input class="updateRecipeButton"type="button" onclick="window.location='updateCollaboratedRecipe.php?q=<?php echo $recipeID; ?>'" value="UPDATE RECIPE" name="updateRecipe">
