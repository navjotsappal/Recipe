...
function readRecipe(&$errorMessage_permissionDenied){
    ...
    try
    {
        ...
        $statement->bindValue(':collaborate', $collaborate);
    ...
    catch(PDOException $e)       //catching exception, source : https://www.w3schools.com/php/php_mysql_insert.asp
    {
        ...
        $userMessageRecipeCreationFail=" 1) Fail to fetch recipe based on collaborated email from the database  2) Fail to set up the database connection";
...
if((isset($_POST['submit'])) and $checkValidations==true) {
    ...
    try
    {
        ...
        $sql = "SELECT * FROM recipe WHERE recipeId=:recipeId and collaborateEmail=:collaborate";  //preparing the SQL statement, source: http://thisinterestsme.com/php-user-registration-form/
        $statement = $connection->prepare($sql);
        $statement->bindValue(':recipeId', $recipeId);     //binding recipeName to prepare statement, then execute the statement. source: http://thisinterestsme.com/php-user-registration-form/
        $statement->bindValue(':collaborate', $collaborate);
        $statement->execute(); //Fetch row.
        ...
        if($row!==false)
        {
            ...
            if($flagImageUpload==true)
            {
                ...
                $statement->bindValue(':collaborateEmail', $_SESSION['email']);
...
<head>
    <meta charset="UTF-8">
    <title>Update Collaborated Recipe</title>
    ...
    <script src="js/updateCollaborateRecipe.js"></script>
        ...
        <div class="container containerWidth">                                  <!--outer div for SignUp, source: https://www.w3schools.com/css/tryit.asp?filename=trycss_form_responsive-->
            ...
            <div class="container">
                ...
                <div class="row"  >  <!-- source:  https://www.w3schools.com/css/tryit.asp?filename=trycss_form_responsive */-->
                    ...
                    <br>
                    <h1 class="titleHeading" style="padding: 0 0.5em; margin-bottom: -0.25em;"><b> Update collaborated recipe</b></h1>
                    <br>
                    <br>
                ...
                <div class="row">                                <!-- source:  https://www.w3schools.com/css/tryit.asp?filename=trycss_form_responsive */-->
                    ...
                    <div class="columnOne">
                        ...
                        <div>
                            ...
                            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <label style="font-size: 1em;">You don't have permission to change fields marked grey.</label>
                                            <label style="font-size: 1em;">In case you want to change timeshared email and the number of days associated, you need to request owner of the recipe to update those fields for you.</label>
                            ...
                            <input type="email" title="Sorry! You don't have permission to change collaborate email." readonly id="collaborateEmailInput" placeholder="Please enter email (user@email.com) of the user." name="collaborateEmail"  value="<?php echo $collaborateEmail;?>" style="background-color: #babdca;" > <br>
                        ...
                        <div>
                            ...
                            <input title="Sorry! You don't have permission to change share email." readonly type="email" id="shareEmailInput" placeholder="Please enter email (user@email.com) of the user." name="shareEmail"  value="<?php echo $shareEmail;?>" style="background-color: #babdca;"> <br>
                        ...
                        <div>
                            ...
                            <input style="margin-bottom: 0em;background-color: #babdca;"  title="Sorry! You don't have permission to change share time." readonly type="number" id="shareTimeInput" pattern="[0-9]{1,3}" title="Only digits allowed !" min="1" max="365" placeholder="Only digits allowed. Adding user email will activate this textbox." name="shareTime"  value="<?php echo $shareTime;?>">
